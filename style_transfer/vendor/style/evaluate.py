...
def check_opts(opts):
    ...
    if not os.path.exists(opts.checkpoint_dir) and not os.path.exists(opts.checkpoint_dir+".meta"):
        print(opts.checkpoint_dir, " NOT FOUND!")
        exit()
...
def style_rendering(ckpt=None, in_path=None, out_path=None):
    opts = {}
...
if __name__ == '__main__':
    style_rendering(
    ckpt='D:\OneDrive\A研究生论文\论文代码\MyWebApplications\style_transfer/vendor\style\examples\checkpoints/fns.ckpt',
    in_path = 'D:\OneDrive\A研究生论文\论文代码\MyWebApplications/style_transfer/static/upload_images/Koala.jpg',
    out_path = 'D:\OneDrive\A研究生论文\论文代码\MyWebApplications\style_transfer/static/generate_images/0427_1.jpg')
